                ...
                <div class="row">
                  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                    <ul id="demo1_thumbs" class="slideshow_thumbs">
                      <li>
                        <a href="/public/img/<?= $productDetails['image'] ?>">
                          <div class=" thumb-img"><img
                              src="/public/img/<?= $productDetails['image'] ?>" alt=""></div>
                        </a>
                      </li>
                      <li>
                        <a href="/public/img/<?= $productDetails['image'] ?>">
                      ...
                      <li>
                        <a href="/public/img/<?= $productDetails['image'] ?>" alt="">
                          <div class=" thumb-img"><img
                              src="/public/img/<?= $productDetails['image'] ?>" alt=""></div>
                        </a>
                      </li>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="product-single">
                      ...
                      <p class="product-price" style="font-size: 38px;">
                        ...
                        <strike>$<?= $productDetails['price_sale'] ?></strike>
                      </p>
                  ...
                  <div class="row">
                    <div class="customer-reviews">
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <p class="reviews-text">By <span class="text-default">Michael Byrd</span> on
                          14 August 2017 </p>
                        <p>Mauris aliquet augue seenim finibusat consectetur metus congutiam
                          convallis aliquam conguen ornare exdolornon scelerisque nisl fringilla
                          ut. Maecenas faucibus purus id elementum laoreen a hendrerit ested
                          laoreet nibh vel lacus sagittis, eu laoreet metus viverraed rutrum.</p>
                      </div>
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="customer-reviews">
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <p class="reviews-text">By <span class="text-default">Marc Scott</span> on
                          13 August 2017 </p>
                        <p>Vivamus molestie enim ut libero condimentumvel malesuada mivulpuorem
                          ipsum dolor sitamet consectetur adipiscing elinec semper orcinec
                          ultricies ultricieunc velitest variussed suscipit sed dignissim
                          acanteras aliquet magna ipsum dictum vulputate dolor suscipit non. </p>
                      </div>
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="divider-line"></div>
                      </div>
                ...
                <a href="/productDetails/<?= $product['productId'] ?>">
                  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 mb30">
                    <div class="product-block">
                      <div class="product-img"><img src="/public/img/<?= $product['image'] ?>" alt="">
                      </div>
