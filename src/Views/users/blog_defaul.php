                    ...
                    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                        <div class="post-block ">
                            ...
                            <div class="post-content">
                                ...
                                <p>Phasellus vehicula metus ligula, et aliquam massa eleifend nonaurisac lectus vehicula
                                    nisl suscipit sagittis raesent sed mi convallis pulvinaex aclobortis risuurabitur
                                    laoreet tellus et feugiat viverra magnanisi pretium nequenon aliquamarcu dolor in
                                    nuci varius natoque penatibusete.
                                    <br>
                                    <br> Etiam sed lorem sapieuis pharetrasedx in frinliquam acpurus semorbi nonmagna
                                    idipsum lacinia vehicula isnt egetut orcuspendisse malesuada tempus liberosed
                                    tinciduntnisi pulvinar auisque finibus molestie congue one etiam bibendum id magna
                                    nec iaculiuisque tempor purus sed elit dapibus consectetu fermentum elementums
                                    turpis sed ornarerci varius natoque penatibuset magnis dis parturient montes
                                    nascetue.
                                </p>
                                <div class="mb40">
                                    ...
                                    <p> Aliquam idnisi consectetur auctor libero sagittis, tempor elituspendisse sit
                                        ...
                                        nullas. </p>
                                    <p>Eros lacusac lorem tristique arcu facilisisquislacinia eratn lacinia Praesent vel
                                        aliquet urnaauris molestie sollicitudin nisl non volutp risus lorem ipusm lorem
                                        ipusm dolor sit famese gestas. </p>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                        <div class="related-post-content">
                                            ...
                                            <div class="related-img">
                                                <a href="#" class="imghover"><img src="images/related_post_1.jpg" alt=""
                                    ...
                                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                        <div class="related-post-content">
                                            <!-- related post -->
                                            <div class="related-img">
                                                <a href="#" class="imghover"><img src="images/related_post_2.jpg" alt=""
                                                        class="img-responsive"></a>
                                            </div>
                                            <h4 class="related-title"><a href="#" class="title">Online Mobile Store</a>
                                            </h4>
                                    ...
                                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                        <div class="related-post-content">
                                            <!-- related post -->
                                            <div class="related-img">
                                                <a href="#" class="imghover"><img src="images/related_post_3.jpg" alt=""
                                                        class="img-responsive"></a>
                                            </div>
                                            <h4 class="related-title"><a href="#" class="title">E-Commerce Free
                                                    Template</a></h4>
                                ...
                                <div class="nav-links">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 nopr">
                                        <div class="nav-previous">
                                            ...
                                            <h3 class="previous-next-title"><a href="#" class="title">E-Commerce Free
                                                    Template</a></h3>
                                        </div>
                                        <!-- /. nav previous -->
                                    </div>
                        ...
                        <div class="author-block">
                            ...
                            <div class="author-content">
                                ...
                                <p>Vestibulum pellentesque sitamet arcuporttitor maxi hasellus pellentesques turpisat
                                    auctor volutporbi nuncaugue suscipit nonest sed ullamcorper porta duaecenas
                                    elementum egestas suscipitn elementum.</p>
                                <a href="#" class="btn btn-primary btn-sm">View All Post</a>
                            </div>
                        </div>
                        <!-- /.post author -->
                        <!--comments start-->
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <ul class="comment-list">
                                        <li>
                                            ...
                                            <ul class="childern">
                                                <li>
                                                    <div class="comment-author"> <img src="images/user_img_3.jpg" alt=""
                                                            class="img-circle"> </div>
                                                    <div class="comment-info">
                                                        <div class="comment-header">
                                                        ...
                                                        <div class="comment-content">
                                                            <p>Curabitur hendrerit fringilla eilla hendrerit leo eget
                                                                suscipit consequat ac orci.</p>
                                                            <a href="#" class="btn-link comment-link">Reply</a>
                                                        </div>
                                                    </div>
                                                </li>
                        ...
                        <ul>
                            <li>
                                <div class="recent-post">
                                    <h5 class="recent-title "><a href="#" class="title">Online Mobile Store E-Commerce
                                            Free Template</a></h5>
                                    <div class="meta">
                            ...
                            <li>
                                <div class="recent-post">
                                    <h5 class="recent-title"><a href="#" class="title">Mobile Phones Online Shopping
                                        </a></h5>
                                    <div class="meta">
                                        <span class="meta-date">20 December, 2020</span>
                                    </div>
