                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb30">
                                <div class="product-block">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-meta"><a href="/productDetails/<?= $product['productId'] ?>"
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="st-pagination">
                                    <ul class="pagination">
                                        ...
                                        <?php if ($page > 1): ?>
                                        <!-- Kiểm tra nếu không phải là trang đầu tiên -->
                                        <li><a href="?page=<?= $page - 1 ?>" aria-label="previous"><span
                                                    aria-hidden="true" tabindex="-1">Previous</span></a></li>
                                        <?php endif; ?>
                                        ...
                                        <?php endfor; ?>
                                        <?php if ($page < $count): ?>
                                        <!-- Kiểm tra nếu không phải là trang cuối cùng -->
                                        <li><a href="?page=<?= $page + 1 ?>" aria-label="Next"><span aria-hidden="true"
                                                    tabindex="+1">Next</span></a></li>
                                        <?php endif; ?>
                                    </ul>
                                </div>
                            </div>
