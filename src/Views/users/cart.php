                                ...
                                <div class="cart">
                                    <table class="table table-bordered ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><a href="#"><img style="width: 80px; height: 100px;"
                                                            src="../public/userslte/images/<?= $item[5] ?>" alt=""></a>
                                                        ...
                                                        <div class="product-quantity">
                                                            <div class="quantity">
                                                                <input type="number" class="input-text qty text"
                                                                    step="1" min="1" max="6" name="quantity" value="1"
                                                                    title="Qty" size="4" pattern="[0-9]*">
                                                                <input type="number" class="input-text qty text"
                                                                    step="1" min="1" name="quantity"
                                                                    value="<?= $item[4] ?>" title="Qty" size="4"
                                                                    pattern="[0-9]*">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><?= (int)$item[3] * (int)$item[4] ?>$</td>
                                                    <th scope="row"><a href="/removeitem?productId=<?= $item[1] ?>"
                                                            class="btn-close"><i class="fa fa-times-circle-o"></i></a>
                                                    </th>
                                                    <th scope="row"><button class="btn btn-primary btn-block"
                                                            type="submit">Buy
                                                            Now</button></th>
                                                </form>
