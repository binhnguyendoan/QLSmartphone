                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input id="id" name="id" type="hidden" class="form-control"
                                        placeholder="Enter Your Name" value="<?= $_SESSION['user']['id'] ?>" required />
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input id="address" name="address" type="text" class="form-control"
                                        placeholder="Enter Your Address" value="<?= $_SESSION['user']['address'] ?>"
                                        required />
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input id="city" name="city" type="text" class="form-control"
                                        placeholder="Enter Your City" value="<?= $_SESSION['user']['city'] ?>"
                                        required />
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input id="country" name="country" type="text" class="form-control"
                                        placeholder="Enter Your Country" value="<?= $_SESSION['user']['country'] ?>"
                                        required />
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input id="zipcode" name="zipcode" type="text" class="form-control"
                                        placeholder="Enter Your Zipcode" value="<?= $_SESSION['user']['zipcode'] ?>"
                                        required />
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input id="phone" name="phone" type="text" class="form-control"
                                        placeholder="Enter Your Phone Number" value="<?= $_SESSION['user']['phone'] ?>"
                                        required />
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input id="email" name="email" type="email" class="form-control"
                                        placeholder="Enter Your Email" value="<?= $_SESSION['user']['email'] ?>"
                                        required />
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
