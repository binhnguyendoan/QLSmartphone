                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $item[2] ?></td>
                                                <td class="d-flex align-items-center justify-content-center vertical-text">
                                                    <?= $item[4] ?></td>
                                                <td class="d-flex align-items-center justify-content-center vertical-text">
                                                    <?= $item[5] ?></td>
                                                <td class="d-flex align-items-center justify-content-center vertical-text">
                                                    <span
                                                        class="<?= ($item[7] == 0) ? "badge bg-warning" : "badge bg-success" ?>"><?= ($item[7] == 0) ? "Pending" : "Paid" ?>
                                                </td>
                                                <td class="d-flex align-items-center justify-content-center vertical-text">
                                                    <?= $item[8] ?></td>
                                                <td class="d-flex align-items-center justify-content-center vertical-text">
                                                ...
                                                <td class="d-flex align-items-center justify-content-center vertical-text">
                                                    <a href="#">
                                                        <?= ($item[7] == 0) ? "Payment" : "View Details" ?></a>
                                                </td>
                                            </tr>
                                        <?php endforeach;
                                        } else {
