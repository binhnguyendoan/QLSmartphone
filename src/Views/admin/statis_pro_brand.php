...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <div class="container">
            <h3 class="text-center">Thống kê số lượng sản phẩm theo thương hiệu</h3>
            ...
            <div style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap;">
                ...
                <!-- Chú thích -->
                <div style="flex: 1; min-width: 400px; padding-left: 10px; margin-left: 10px;">
...
// Tạo mảng các nhãn và dữ liệu cho biểu đồ
